      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl w-full max-w-md shadow-2xl border border-gray-100 dark:border-slate-800 animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        {success ? (
          ...
          <div className="p-6 space-y-4">
            ...
            {[
              { label:'Mot de passe actuel', val:currentPwd, set:setCurrentPwd, show:showCurrent, toggle:()=>setShowCurrent(!showCurrent) },
              { label:'Nouveau mot de passe', val:newPwd, set:setNewPwd, show:showNew, toggle:()=>setShowNew(!showNew) },
              { label:'Confirmer',            val:confirmPwd, set:setConfirmPwd, show:showConfirm, toggle:()=>setShowConfirm(!showConfirm) },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {localLang !== lang && (
                  <div className="mt-4 p-3 rounded-2xl bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 flex items-center gap-2 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <p className="text-xs text-orange-700 dark:text-orange-400 font-medium">
                      {localLang === 'fr' && 'La langue passera au français après sauvegarde.'}
                      {localLang === 'en' && 'Language will switch to English after saving.'}
                      {localLang === 'ar' && 'ستتغير اللغة إلى الدارجة بعد الحفظ.'}
                    </p>
                  </div>
                )}
              </section>
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 bg-white dark:bg-slate-900 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-sm text-center space-y-3">
                <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Langue active</p>
