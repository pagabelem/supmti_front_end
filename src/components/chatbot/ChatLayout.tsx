...
//     <div className="flex flex-col h-full w-full bg-[#f8fafc] dark:bg-slate-950 overflow-hidden">
...
//       <div className="flex-1 overflow-y-auto scroll-smooth bg-[#f1f5f9]/30 dark:bg-slate-900/50">
//         <MessageList />
//       </div>
